...
class MainViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        // import events data
        let event1 = Event(eventImgName: "face", eventName: "Forte Coffee Chats: Get to know Forte!", eventTime: "14:00-16:00", eventDate: "2018-11-30", eventLocation: ["Amit Bhatia Libe Cafe", "Central"], eventFood: "coffee", eventDetail: "Join Forte Campus at Cornell at Libe Cafe!")
        originalArray = [event1]
